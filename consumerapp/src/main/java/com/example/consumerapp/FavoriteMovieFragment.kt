...
class FavoriteMovieFragment : Fragment() {
    ...
    private val URI = Uri.parse("content://com.ricky.submisi/FavoriteMovie")
    ...
    override fun onCreateView(
        ...
        viewOfLayout = inflater.inflate(R.layout.fragment_favorite_movie, container, false)

        adapter = MovieAdapter(listOf())
        val list = viewOfLayout.favorite_movie_list
    ...
    private fun getData(){
        ...
        GlobalScope.launch(Dispatchers.Main) {
            ...
            if (movies.isNotEmpty()){
                ...
                viewOfLayout.movie_no_data.visibility = View.GONE
            }
            else{
                adapter.items = listOf()
                viewOfLayout.movie_no_data.visibility = View.VISIBLE
            }
